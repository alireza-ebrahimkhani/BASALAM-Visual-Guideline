...
calculator_submit.addEventListener('click' , ()=>{
    ...
    calculator_item[0].innerHTML = Math.floor(hiUnit * 1);
    calculator_item[1].innerHTML = Math.floor(hiUnit * 1.75);
    calculator_item[2].innerHTML = Math.floor(hiUnit * 1.2);
    calculator_item[3].innerHTML = Math.floor(hiUnit * 0.8);
    calculator_item[4].innerHTML = Math.floor(hiUnit * 0.65); 
    calculator_item[5].innerHTML = Math.floor(hiUnit * 0.45);
    calculator_item[6].innerHTML = Math.floor(hiUnit * 0.35);
    calculator_item[7].innerHTML = Math.floor(hiUnit * 0.6);
    calculator_item[8].innerHTML = Math.floor(hiUnit * 0.35);
    calculator_item[9].innerHTML = Math.floor(hiUnit * 0.25);
    calculator_item[10].innerHTML = Math.floor(hiUnit * 0.20);
});
